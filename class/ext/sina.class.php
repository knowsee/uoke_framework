 ...
 */
define("WB_AKEY", '3625794630');
define("WB_SKEY", '8cf96d5f2097537b16ecf463b2cc0b85');
define("WB_CALLBACK_URL", 'callback.php');

class sina_Callback extends SaeTOAuthV2 {
    
    function __construct($client_id = WB_AKEY, $client_secret = WB_SKEY, $access_token = NULL, $refresh_token = NULL) {
    ...
    function getToken($type, $keys) {
        return $this->getAccessToken($type, $keys);
    }
    
    function getUrl($callback = WB_CALLBACK_URL) {
        return $this->getAuthorizeURL($callback);
    }
    
}

class sina_Info extends SaeTClientV2 {
